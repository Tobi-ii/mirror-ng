...
export default function ExecutiveDashboard({ transactions }) {
  ...
  return (
    <div className="space-y-10 max-w-6xl mx-auto">
      ...
      {/* ── STICKY HEADER & KPIs ─────────────────────────────────────── */}
      <div className="sticky top-0 z-40 bg-[#050608]/90 backdrop-blur-xl pt-6 pb-6 -mx-6 px-6 border-b border-white/5 space-y-6">
        <div>
          <h1 className="text-4xl font-black uppercase italic tracking-tighter text-white">Executive View</h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {kpis.map((kpi, i) => (
            <div key={i} className="bg-[#0a0c10] border border-white/5 rounded-[2rem] p-5 space-y-1">
              <p className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-600">{kpi.label}</p>
              <p className={`text-xl font-black tabular-nums ${kpi.color}`}>{kpi.value}</p>
              <p className="text-[9px] text-slate-700">{kpi.sub}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-[#0a0c10] border border-white/5 rounded-[2.5rem] p-8 space-y-6">
          <div className="flex items-center justify-between flex-wrap gap-3">
            <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500">Spend Breakdown</h3>
          ...
          {pieData.length > 0 ? (
            <>
              <DonutChart data={pieData} size={200} onSliceClick={handleSliceClick} selectedSlice={selectedSlice} />
        ...
        <div className="bg-[#0a0c10] border border-white/5 rounded-[2.5rem] p-8 space-y-6">
          <div>
            <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-4">Daily Spend Trend</h3>
            <TrendLine transactions={transactions} />
          </div>
          <div className="pt-8 border-t border-white/5">
            <h3 className="text-xs font-black uppercase tracking-[0.3em] text-slate-500 mb-4">Daily Credit vs Debit</h3>
      ...
      <div className="bg-[#0a0c10] border border-white/5 rounded-[2.5rem] p-8 space-y-6 w-full">
