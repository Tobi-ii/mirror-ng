...
export default function SpendChart({ transactions }) {
  ...
  return (
    <div className="bg-[#0a0c10] border border-white/5 rounded-[2.5rem] p-8 space-y-8 shadow-2xl">
      {/* Category Breakdown */}
      ...
      <div className="pt-6 border-t border-white/5 space-y-4">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Total In</span>
          </div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Total Out</span>
          </div>
          <span className="text-sm font-black text-white italic">
