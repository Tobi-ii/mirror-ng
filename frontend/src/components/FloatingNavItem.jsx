...
export default function FloatingNavItem({ 
  ...
  return (
    <div className="relative group">
      ...
      {!active && (
        <div className="absolute -top-14 left-1/2 -translate-x-1/2 px-4 py-2 bg-[#0a0c10] border border-white/10 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-xl opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300 pointer-events-none whitespace-nowrap shadow-2xl z-20">
          {label}
