...
export default function BankCard({ bank, balance, account_last4, last_updated, totalCredit = 0, totalDebit = 0, onClick }) {
  ...
  return (
    ...
    <div className="relative group w-[340px] shrink-0"> 
      <div 
        onClick={onClick} 
        className={`rounded-[2.5rem] bg-gradient-to-br ${color} text-white shadow-2xl flex relative overflow-hidden transition-all duration-500 ease-in-out group-hover:-translate-y-2 group-hover:shadow-indigo-500/20 active:scale-[0.97] cursor-pointer h-52`}
      >
        ...
        <div className="flex-[1.6] p-7 flex flex-col justify-between z-10 min-w-0 transition-all duration-500">
